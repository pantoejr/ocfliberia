            ...
            <div class="card-body p-4">
                <form method="POST" action="{{ route('distributions.store') }}">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="visit_id" name="visit_id" disabled>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="distribution_type_id" name="distribution_type_id" disabled>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="distribution_date"
                            class="form-control" value="{{ $distribution->distribution_date }}" disabled />
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            Beneficiary List
                    ...
                    <div class="form-group">
                        <a href="{{ route('distributions.index') }}" class="btn btn-info">Back</a>
                    </div>
                </form>
            </div>
        </div>
                    ...
                    success: function(response) {
                        ...
                        response.forEach(function(beneficiary) {
                            var checkbox = '<div class="col-md-2">' +
                                            ...
                                            '<input type="checkbox" id="beneficiaryId" class="custom-control-input" name="beneficiaries[]" value="' + beneficiary.id + '" checked disabled />' +
