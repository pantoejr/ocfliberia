        ...
        <div class="card">
            ...
            <div class="card-body p-4">
                    <div class="form-group">
                        <label>Name</label>
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ $visit->name }}" disabled />
                        @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error('school_id')
                            is-invalid
                        @enderror" id="school_id" name="school_id" disabled>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="sponsor_id" name="sponsor_id" disabled >
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" name="description" disabled class="form-control @error('description') is-invalid @enderror">
                            {{ $visit->description }}
                        </textarea>
                        @error('description')
                            <span class="invalid-feedback" role="alert">
                    ...
                    <div class="form-group">
                        <a href="{{ route('visits.index') }}" class="btn btn-info">Back to List</a>
                    </div>
            </div>
        </div>
    </div>
